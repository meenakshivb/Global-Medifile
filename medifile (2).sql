...
--
-- Host: localhost
-- Generation Time: Apr 12, 2022 at 04:05 AM
...
(2, 'Megha photo 40kb_9c1kUld.jpg', 'Teneena james', 'meghatb@gmail.com', '23', '8089186044', 'Md. california', 'Cardiology', 'aaa', '2019-10-25', '100000', 'doctor', 'None', 'Teneena1', 'Teneena1', '379411', '429475', 'renai Medicity', 'None', 0, 'Afternoon', 10),
...
(4, 'c3.jpg', 'george', 'geo56@gmail.com', 'on', '987654323', 'mbbs', 'Cardiology', 'heart', '2022-02-09', '300000', 'doctor', 'None', 'Reshma@123', 'Reshma@123', '484312', '568315', 'jan', '', 0, '', 0),
(5, 'banner-1.jpg', 'jenny', 'jenny@gmail.com', '45', '9876543232', 'mbbs', 'Others', 'heart', '2016-10-07', '300000', 'doctor', '', 'Jenny@123', 'Jenny@123', '520960', '607891', 'PVS Memmorial Hospital', 'Forenoon', 50, 'Afternoon', 50);
...
(4, 'Cardiology', '6862', 'reshma', '987654323', 'reshma\r\njames', 'good', '568315', 'jan');
...
('c2_jSDTdUI.jpg', 'fasil', 'fasil@gmail.cooom', '23', 'Male', '1998-10-22', '987654323', 'fasil villa', '1232', '1234567898765432', '123321', 'O-', 'Jan@1200', 'JAn@1200', '189073', 'patient'),
...
('c2.jpg', 'fasil', 'fasil@gmail.cooom', '23', 'Male', '1998-10-22', '987654323', 'fasil villa', '1232', '1234567898765432', '123321', 'O-', 'Jan@1200', 'Jan@1200', '592258', 'patient'),
...
(1, 'george', '484312', 'one', '2022-02-23', 'None', 'sdfghjkl', 'xcvbnm,fghjkl;tyuiop', '568315', '');
...
(6, ' fasil', ' 189073', '2022-02-03', 'asa', 'sd', '', '', '', '484312', '568315'),
(7, 'Dilsha M Deleep', '595228', '2022-02-24', 'heartattack', 'minor case', '', '', '', '910510', '429475');
...
(17, '631585', 'lakshmi', 'Peeter123', 'patient', 'NULL'),
(18, '918316', 'lcc', 'lcc123LL', 'hospital', 'NULL'),
(19, '568315', 'jan', 'Jan@1200', 'hospital', 'NULL'),
(20, '592258', 'fasil', 'Jan@1200', 'patient', 'NULL'),
(21, '189073', 'fasil', 'Jan@1200', 'patient', 'NULL'),
(22, '484312', 'george', 'Reshma@123', 'doctor', '568315'),
(23, '520960', 'jenny', 'Jenny@123', 'doctor', '607891');
...
(2, '2', 'ssdfs', 'Forenoon', 'Afternoon', '21.3', 'csdcsd'),
(3, '3', 'rewrr', 'Forenoon', 'Afternoon', '21.3', 'cbvdf'),
(4, '4', 'sas', 'Forenoon', 'Afternoon', '21.3', 'sfaf'),
(5, '5', 'dfsdf', 'Forenoon', 'Afternoon', '21.3', 'dfsdf'),
(6, '6', 'sd', 'Forenoon', 'Afternoon', 'das', ''),
(7, '6', 'sd', 'Forenoon', 'Afternoon', 'das', 'das'),
(8, '7', 'minor', 'Forenoon', 'Afternoon', '21.3', 'fuhbfhsdnf bjinfoidcq');
...
(4, '2022-02-22 00:00:00', 'Cardiology', '484312', '568315', 'New Patient', '2022-02-23', 'fasil', '189073', '987654323', '1'),
(5, '2022-02-22 00:00:00', 'Cardiology', '484312', '568315', 'New Patient', '2022-02-23', 'lakshmi', '631585', '987654323', '2'),
(6, '2022-02-24 00:00:00', 'Cardiology', '910510', '429475', 'Other', '2022-02-24', 'Dilsha M Deleep', '595228', '987654323', '1'),
(7, '2022-03-07 00:00:00', 'Cardiology', '484312', '568315', 'New Patient', '2022-03-08', 'Meenu ', '465376', '987654323', '1');
...
('abel', '885271', 'abel@gmail.com', '7907454292', 'ghj', 'fghjk', 'guest'),
('abel', '885271', 'abel@gmail.com', '7907454292', 'ghj', 'fghjk', 'guest'),
('abel', '885271', 'abel@gmail.com', '7907454292', 'ghj', 'fghjk', 'guest');
...
--
-- Table structure for table `pt_suggest`
--

CREATE TABLE IF NOT EXISTS `pt_suggest` (
...
--
-- Dumping data for table `pt_suggest`
--

INSERT INTO `pt_suggest` (`id`, `name`, `pt_id`, `phone`, `email`, `subject`, `message`) VALUES
(1, 'fasil', 123456, 987654323, 'jan@gmail.com', 'fdfgdffgd', 'wdwdsfnlsdnvklls');
...
(5, 'lcc', 123456, 'qwertyuioooop', '9876543210', 'lcc@gmail.com', 'lcc123LL', 'lcc123LL', 918316, 'hospital'),
(6, 'jan', 7878, 'jan villa', '987654323', 'Jan@gmail.com', 'Jan@1200', 'Jan@1200', 568315, 'hospital'),
(7, 'xyy', 1222, 'xyy', '987654323', 'xyyjjkjk@gmail.com', 'Reshma@123', 'Reshma@123', 464038, 'hospital');
...
('189073', 'jan', 'bro', 'jan vila', '9876543210', 'jan', 'None', 'jan villa', '9876543210', 'fasil');
...
INSERT INTO `st_leave` (`id`, `name`, `st_id`, `leave`, `days`, `date_from`, `date_to`, `subject`, `reason`, `hos_id`, `designation`, `status`) VALUES
(4, 'Meenu ', 465376, 'one', 9, '2019-10-23', 'None', 'personal Matter', 'aaaaa', '429475', 'staff', 'Approved'),
(7, 'Meenu ', 465376, 'one', 1, '2022-02-12', 'None', 'asdfghjk', 'cvbnm,.', '429475', 'staff', ''),
(8, 'Meenu ', 465376, 'one', 1, '2022-02-12', 'None', 'asdfghjk', 'cvbnm,.', '429475', 'staff', '');
