...
urlpatterns = [
    ...
    path('forgotpassword/',userviews.forgotpassword),
    ...
    path('pt_suggestview/',userviews.pt_suggestview, name="pt_diseaseview"),
    ...
    path('st_contactview/',userviews.st_contactview),
    path('st_emergencyview/',userviews.st_emergencyview),
     path('hlistapproved/',views.hlistapproved),
    ...
    path('emergencyview/', userviews.emergencyview, name="emergencyview"),
